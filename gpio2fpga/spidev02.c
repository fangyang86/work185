...
void transfer32(char *p8)
{
	...
	uint8_t rx[ARRAY_SIZE(tx)] = {0,0,0,0 };
...
//void transfer512(char *ptx,char *prx,int xlen)
void transfer512(char *ptx,char *prx,int xlen,int modspeed)
{
	int fd=gfdspi;
	uint8_t u8;
	int ret;
